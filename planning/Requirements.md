...
4. As a student, I want to log my daily stress level, so that I can track how stressed I feel over time.
5. As a student, I want to view my study history, so that I can review my past study patterns.
6. As a student, I want to view my stress level history, so that I can identify trends in my mental wellbeing.
7. As a student, I want to receive reminders to take breaks while studying, so that I can avoid burnout.
8. As a student, I want to receive study time reminders, so that I can manage my time more effectively.
9. As a student, I want to see visual charts of my study hours and stress levels, so that I can better understand my habits.
10. As a student, I want to receive relaxation tips or suggestions, so that I can reduce stress.
11. As a student, I want to access mental wellness resources, so that I can learn strategies for managing stress.
12. As a student, I want to set personal study goals, so that I can improve my productivity.
...
4. As an admin, I want to review aggregated stress data trends, so that the university can identify student wellbeing issues.
...
4. The system shall allow students to record daily study hours.
5. The system shall allow students to record their stress level.
6. The system shall allow students to view study history and trends.
7. The system shall allow students to view stress level history.
8. The system shall provide reminders for study breaks and study sessions.
9. The system shall provide relaxation tips when students experience high stress levels.
10. The system shall allow students to access emergency hotline contacts and counselling services.
11. The system shall allow administrators to manage user accounts.

The system shall allow administrators to monitor system usage and activity.

**Non-Functional Requirements**
Usability: simple interface without technical knowledge
Performance: low latency, pages should load within 2 seconds
Security: authenticated user and restricted access to personal study and stress data
Reliability: high data persistence to prevent loss of historical logs
Accessibility: responsive design compatible with mobile and desktop devices
